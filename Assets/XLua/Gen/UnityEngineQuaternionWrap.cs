...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineQuaternionWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Quaternion), L, translator, 2, 8, 6, 5);
		    ...
		    Utils.BeginClassRegister(typeof(UnityEngine.Quaternion), L, __CreateInstance, 15, 1, 0);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Quaternion q;translator.Get(L, 1, out q);
                        ...
                        UnityEngine.Quaternion __cl_gen_ret = UnityEngine.Quaternion.Normalize( q );
                        translator.PushUnityEngineQuaternion(L, __cl_gen_ret);
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Quaternion other;translator.Get(L, 2, out other);
        ...
        static int _g_get_normalized(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Quaternion __cl_gen_to_be_invoked;translator.Get(L, 1, out __cl_gen_to_be_invoked);
                translator.PushUnityEngineQuaternion(L, __cl_gen_to_be_invoked.normalized);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
