...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineTransformWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Transform), L, translator, 0, 21, 19, 13);
        ...
        static int _m_SetParent(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Transform p = (UnityEngine.Transform)translator.GetObject(L, 2, typeof(UnityEngine.Transform));
                    
                    __cl_gen_to_be_invoked.SetParent( p );
        ...
        static int _m_Rotate(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<UnityEngine.Vector3>(L, 2)) 
                {
                    UnityEngine.Vector3 eulers;translator.Get(L, 2, out eulers);
                    
                    __cl_gen_to_be_invoked.Rotate( eulers );
                ...
                if(__gen_param_count == 3&& translator.Assignable<UnityEngine.Vector3>(L, 2)&& translator.Assignable<UnityEngine.Space>(L, 3)) 
                {
                    ...
                    __cl_gen_to_be_invoked.Rotate( eulers, relativeTo );
		    ...
		    try {
                ...
                
                {
                    string n = LuaAPI.lua_tostring(L, 2);
                        ...
                        UnityEngine.Transform __cl_gen_ret = __cl_gen_to_be_invoked.Find( n );
