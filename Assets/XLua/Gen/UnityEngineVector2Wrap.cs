...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineVector2Wrap 
    {
        public static void __Register(RealStatePtr L)
        {
		    ...
		    Utils.BeginClassRegister(typeof(UnityEngine.Vector2), L, __CreateInstance, 18, 8, 0);
        ...
        static int _m_Equals(RealStatePtr L)
        {
		    try {
                ...
                {
                    UnityEngine.Vector2 other;translator.Get(L, 2, out other);
		    ...
		    try {
                ...
                
                {
                    UnityEngine.Vector2 inDirection;translator.Get(L, 1, out inDirection);
                        ...
                        UnityEngine.Vector2 __cl_gen_ret = UnityEngine.Vector2.Perpendicular( inDirection );
                        translator.PushUnityEngineVector2(L, __cl_gen_ret);
