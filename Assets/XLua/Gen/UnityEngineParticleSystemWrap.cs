...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineParticleSystemWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.ParticleSystem), L, translator, 0, 12, 31, 3);
            ...
            Utils.RegisterFunc(L, Utils.GETTER_IDX, "automaticCullingEnabled", _g_get_automaticCullingEnabled);
        ...
        static int _m_TriggerSubEmitter(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)) 
                {
                    int subEmitterIndex = LuaAPI.xlua_tointeger(L, 2);
                    
                    __cl_gen_to_be_invoked.TriggerSubEmitter( subEmitterIndex );
                    
                    
                    
                    return 0;
                }
                if(__gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<UnityEngine.ParticleSystem.Particle>(L, 3)) 
                {
                    int subEmitterIndex = LuaAPI.xlua_tointeger(L, 2);
                    UnityEngine.ParticleSystem.Particle particle;translator.Get(L, 3, out particle);
                    
                    __cl_gen_to_be_invoked.TriggerSubEmitter( subEmitterIndex, ref particle );
                    translator.Push(L, particle);
                        translator.Update(L, 3, particle);
                ...
                if(__gen_param_count == 3&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 2)&& translator.Assignable<System.Collections.Generic.List<UnityEngine.ParticleSystem.Particle>>(L, 3)) 
                {
                    int subEmitterIndex = LuaAPI.xlua_tointeger(L, 2);
                    ...
                    __cl_gen_to_be_invoked.TriggerSubEmitter( subEmitterIndex, particles );
        ...
        [MonoPInvokeCallbackAttribute(typeof(LuaCSFunction))]
        static int _g_get_automaticCullingEnabled(RealStatePtr L)
        {
		    try {
                ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			
                UnityEngine.ParticleSystem __cl_gen_to_be_invoked = (UnityEngine.ParticleSystem)translator.FastGetCSObj(L, 1);
                LuaAPI.lua_pushboolean(L, __cl_gen_to_be_invoked.automaticCullingEnabled);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
