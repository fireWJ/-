...
namespace XLua.CSObjectWrap
{
    ...
    public class UnityEngineRendererWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			...
			Utils.BeginObjectRegister(typeof(UnityEngine.Renderer), L, translator, 0, 6, 26, 21);
        ...
        static int _m_HasPropertyBlock(RealStatePtr L)
        {
		    try {
                ...
                
                {
                        ...
                        bool __cl_gen_ret = __cl_gen_to_be_invoked.HasPropertyBlock(  );
        ...
        static int _m_SetPropertyBlock(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<UnityEngine.MaterialPropertyBlock>(L, 2)) 
                {
                ...
                if(__gen_param_count == 3&& translator.Assignable<UnityEngine.MaterialPropertyBlock>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    UnityEngine.MaterialPropertyBlock properties = (UnityEngine.MaterialPropertyBlock)translator.GetObject(L, 2, typeof(UnityEngine.MaterialPropertyBlock));
                    int materialIndex = LuaAPI.xlua_tointeger(L, 3);
                    
                    __cl_gen_to_be_invoked.SetPropertyBlock( properties, materialIndex );
        ...
        static int _m_GetPropertyBlock(RealStatePtr L)
        {
		    try {
                ...
                if(__gen_param_count == 2&& translator.Assignable<UnityEngine.MaterialPropertyBlock>(L, 2)) 
                {
                    ...
                    __cl_gen_to_be_invoked.GetPropertyBlock( properties );
                ...
                if(__gen_param_count == 3&& translator.Assignable<UnityEngine.MaterialPropertyBlock>(L, 2)&& LuaTypes.LUA_TNUMBER == LuaAPI.lua_type(L, 3)) 
                {
                    ...
                    __cl_gen_to_be_invoked.GetPropertyBlock( properties, materialIndex );
        ...
        static int _m_GetMaterials(RealStatePtr L)
        {
		    try {
                ...
                {
                    System.Collections.Generic.List<UnityEngine.Material> m = (System.Collections.Generic.List<UnityEngine.Material>)translator.GetObject(L, 2, typeof(System.Collections.Generic.List<UnityEngine.Material>));
                    
                    __cl_gen_to_be_invoked.GetMaterials( m );
        ...
        static int _m_GetSharedMaterials(RealStatePtr L)
        {
		    try {
                ...
                
                {
                    ...
                    __cl_gen_to_be_invoked.GetSharedMaterials( m );
        ...
        static int _g_get_renderingLayerMask(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer __cl_gen_to_be_invoked = (UnityEngine.Renderer)translator.FastGetCSObj(L, 1);
                LuaAPI.xlua_pushuint(L, __cl_gen_to_be_invoked.renderingLayerMask);
            } catch(System.Exception __gen_e) {
                return LuaAPI.luaL_error(L, "c# exception:" + __gen_e);
            }
            return 1;
        ...
        static int _s_set_renderingLayerMask(RealStatePtr L)
        {
		    try {
                ...
                UnityEngine.Renderer __cl_gen_to_be_invoked = (UnityEngine.Renderer)translator.FastGetCSObj(L, 1);
                __cl_gen_to_be_invoked.renderingLayerMask = LuaAPI.xlua_touint(L, 2);
